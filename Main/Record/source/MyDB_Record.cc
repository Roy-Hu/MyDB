...
pair<func, MyDB_AttTypePtr> MyDB_Record ::plus(pair<func, MyDB_AttTypePtr> lhs,
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::minus(pair<func, MyDB_AttTypePtr> lhs,
                                                pair<func, MyDB_AttTypePtr> rhs)
{
    // if both sides can be cast upwards to be ints, then do so
    if (lhs.second->promotableToInt() && rhs.second->promotableToInt())
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::times(pair<func, MyDB_AttTypePtr> lhs,
                                                pair<func, MyDB_AttTypePtr> rhs)
{
    // if both sides can be cast upwards to be ints, then do so
    if (lhs.second->promotableToInt() && rhs.second->promotableToInt())
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::divide(pair<func, MyDB_AttTypePtr> lhs,
                                                 pair<func, MyDB_AttTypePtr> rhs)
{
    // if both sides can be cast upwards to be ints, then do so
    if (lhs.second->promotableToInt() && rhs.second->promotableToInt())
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::andd(pair<func, MyDB_AttTypePtr> lhs,
                                               pair<func, MyDB_AttTypePtr> rhs)
{
    // if both sides can be cast upwards to be ints, then do so
    if (lhs.second->isBool() && rhs.second->isBool())
