...
public:
    ...
    //
    // myRecord.compileComputation ("< (+ (double [34.45], + ( [firstAtt], / ([secAtt], [secAtt]))),
    // int [20]) ");
    //
    ...
    // builds a function that returns true if lhs < rhs; the comparison is done by running whatever
    // computation is encoded by the string "computation" on both lhs and rhs, and then compariing
    // the results obtained using this computation over both.  If the result from lhs is < the
    // result from rhs, then the function returned from buildRecordComparator returns a true;
    // otherwise, it returns a false
    //
    // Note that the encoding of the computation in the string "computation" is exactly the same as
    // the encoding used by the method compileComputation above
    friend function<bool()> buildRecordComparator(MyDB_RecordPtr lhs, MyDB_RecordPtr rhs,
                                                  string computation);
...
private:
    ...
    pair<func, MyDB_AttTypePtr> plus(pair<func, MyDB_AttTypePtr> lhs,
                                     pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> minus(pair<func, MyDB_AttTypePtr> lhs,
                                      pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> times(pair<func, MyDB_AttTypePtr> lhs,
                                      pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> divide(pair<func, MyDB_AttTypePtr> lhs,
                                       pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> gt(pair<func, MyDB_AttTypePtr> lhs,
                                   pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> lt(pair<func, MyDB_AttTypePtr> lhs,
                                   pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> eq(pair<func, MyDB_AttTypePtr> lhs,
                                   pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> neq(pair<func, MyDB_AttTypePtr> lhs,
                                    pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> andd(pair<func, MyDB_AttTypePtr> lhs,
                                     pair<func, MyDB_AttTypePtr> rhs);
    pair<func, MyDB_AttTypePtr> orr(pair<func, MyDB_AttTypePtr> lhs,
                                    pair<func, MyDB_AttTypePtr> rhs);
