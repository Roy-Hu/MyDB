friend struct SFWQuery *makeQueryWithGroupBy(struct ValueList *selectClause,
                                             struct FromList *fromClause, struct CNF *cnf,
                                             struct ValueList *grouping);
friend struct SFWQuery *makeQuery(struct ValueList *selectClause, struct FromList *fromClause,
                                  struct CNF *cnf);
friend struct SFWQuery *makeQueryNoWhere(struct ValueList *selectClause,
...
friend struct CreateTable *makeTableBPlusTree(char *tableName, struct AttList *fromMe,
                                              char *attName);
...
friend struct FromList *appendFromList(struct FromList *appendToMe, char *tableName,
                                       char *aliasName);
