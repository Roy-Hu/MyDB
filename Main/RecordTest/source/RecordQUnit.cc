...
void initialize()
{
    ...
    MyDB_BufferManagerPtr myMgr = make_shared<MyDB_BufferManager>(1024, 16, "test/tempFile");
    MyDB_TableReaderWriter supplierTable(myTable, myMgr);

    // load it from a text file
    supplierTable.loadFromTextFile("test/supplier.tbl");
    ...
    switch (start)
    {
        case 1:
        {
            ...
            bool result = false;
            {
                ...
                MyDB_BufferManagerPtr myMgr =
                    make_shared<MyDB_BufferManager>(1024, 16, "test/tempFile");
        ...
        case 4:
        {
            ...
            int counter = 0;
            {
                ...
                string s =
                    "10001|Supplier#000010001|00000000|999|12-345-678-9012|1234.56|the special "
                    "record|";
                temp->fromString(s);
        ...
        case 5:
        {
            ...
            const string answer =
                "2|Supplier#000000002|TRMhVHz3XiFuhapxucPo1|5|15-679-861-2259|4032.680000|"
                "furiously "
                "stealthy frays thrash alongside of the slyly express deposits. blithely regular "
                "req|";
            if (result == answer)
                cout << "CORRECT" << endl << flush;
            else
        ...
        case 6:
        {
            ...
            const string answer =
                "10000|Supplier#000010000|R7kfmyzoIfXlrbnqNwUUW3phJctocp0J|19|29-578-432-2146|8968."
                "420000|furiously final ideas believe furiously. furiously final ideas|";
            if (result == answer)
                cout << "CORRECT" << endl << flush;
            else
                cout << "***FAIL***" << endl << flush;
