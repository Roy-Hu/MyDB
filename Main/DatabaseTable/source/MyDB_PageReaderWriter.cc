...
MyDB_PageReaderWriter ::MyDB_PageReaderWriter(bool pinned, MyDB_TableReaderWriter &parent,
                                              int whichPage)
{
    // get the actual page
    if (pinned)
...
bool MyDB_PageReaderWriter ::append(MyDB_RecordPtr appendMe)
{
    ...
    if (recSize > NUM_BYTES_LEFT) return false;
...
void MyDB_PageReaderWriter ::sortInPlace(function<bool()> comparator, MyDB_RecordPtr lhs,
                                         MyDB_RecordPtr rhs)
{
...
MyDB_PageReaderWriterPtr MyDB_PageReaderWriter ::sort(function<bool()> comparator,
