...
bool MyDB_TableRecIterator ::hasNext()
{
    ...
    if (curPage == myTable->lastPage()) return false;
...
MyDB_TableRecIterator ::MyDB_TableRecIterator(MyDB_TableReaderWriter &myParent,
                                              MyDB_TablePtr myTableIn, MyDB_RecordPtr myRecIn)
    : myParent(myParent)
{
    myTable = myTableIn;
    myRec = myRecIn;
