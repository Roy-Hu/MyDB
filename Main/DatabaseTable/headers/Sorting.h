...
// helper function.  Gets two iterators, leftIter and rightIter.  It is assumed that these are
// iterators over sorted lists of records.  This function then merges all of those records into a
// list of anonymous pages, and returns the list of anonymous pages to the caller.  The resulting
// list of anonymous pages is sorted. Comparisons are performed using comparator, lhs, rhs
