    ...
    switch (start)
    {
        case 1:
            ...
            cout << "Initialization.." << flush;
            {
                ...
                MyDB_TablePtr myTable =
                    make_shared<MyDB_Table>("indexvalue", "indexvalue.bin", mySchema);
                MyDB_BufferManagerPtr myMgr =
                    make_shared<MyDB_BufferManager>(131072, 128, "test/tempFile");
                MyDB_TableReaderWriter ivTable(myTable, myMgr);

                // load it from a text file
                ivTable.loadFromTextFile("test/indexvalue.tbl");
            ...
            cout << "Sort a table.." << flush;
            {
                ...
                MyDB_TablePtr outTable =
                    make_shared<MyDB_Table>("indexvalueSorted", "indexvalueSorted.bin",
                                            allTables["indexvalue"]->getSchema());
            ...
            cout << "Compare Sorted Table.." << endl << flush;
            {
                ...
                otherSortedTable.loadFromTextFile("test/indexvalueBigSorted.tbl");
        ...
        case 2:
            ...
            cout << "Sort a table.." << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr outTable =
                    make_shared<MyDB_Table>("indexvalueSortedTwo", "indexvalueSortedTwo.bin",
                                            allTables["indexvalue"]->getSchema());
                MyDB_TableReaderWriter outputTable(outTable, myMgr);
            ...
            cout << "Compare Sorted Table.." << endl << flush;
            {
                ...
                // load up the sorted text file
                otherSortedTable.loadFromTextFile("test/indexvalueBigSortedTwo.tbl");
        ...
        case 3:
            cout << endl
                 << "Test 3: Index - Value pair: Sort an already sorted table:" << endl
                 << flush;
            countCorrect = 0;
            cout << "Sort a table.." << flush;
            {
                ...
                MyDB_BufferManagerPtr myMgr =
                    make_shared<MyDB_BufferManager>(131072, 128, "test/tempFile");
                MyDB_TableReaderWriter indexvalueTable(allTables["indexvalueSortedTwo"],
                                                       myMgr);  // already sorted by value.

                // use the schema to create a table
                MyDB_TablePtr outTable =
                    make_shared<MyDB_Table>("indexvalueSortedThree", "indexvalueSortedThree.bin",
                                            allTables["indexvalue"]->getSchema());
                MyDB_TableReaderWriter outputTable(outTable, myMgr);
            ...
            cout << "Compare Sorted Table.." << endl << flush;
            {
                ...
                // load up the sorted text file
                otherSortedTable.loadFromTextFile(
                    "test/indexvalueBigSortedTwo.tbl");  // pre-sorted by value table
        ...
        case 4:
            cout << endl
                 << "Test 4: Index - Value pair: Sort previous table with reduced run-length:"
                 << endl
                 << flush;
            countCorrect = 0;
            cout << "Sort a table.." << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr outTable =
                    make_shared<MyDB_Table>("indexvalueSortedFour", "indexvalueSortedFour.bin",
                                            allTables["indexvalue"]->getSchema());
                MyDB_TableReaderWriter outputTable(outTable, myMgr);
            ...
            cout << "Compare Sorted Table.." << endl << flush;
            {
                ...
                // load up the sorted text file
                otherSortedTable.loadFromTextFile(
                    "test/indexvalueBigSorted.tbl");  // pre-sorted by index table
        ...
        case 5:
            ...
            cout << "Initialization.." << flush;
            {
                ...
                // load it from a text file
                ivTable.loadFromTextFile("test/empty.tbl");
            ...
            cout << "Sort a table.." << endl << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr outTable = make_shared<MyDB_Table>("emptySorted", "emptySorted.bin",
                                                                 allTables["empty"]->getSchema());
                MyDB_TableReaderWriter outputTable(outTable, myMgr);
        ...
        case 6:
            ...
            cout << "Initialization.." << flush;
            {
                ...
                // load it from a text file
                supplierTable.loadFromTextFile("test/supplierBig.tbl");
            ...
            cout << "Sort a table.." << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr outTable = make_shared<MyDB_Table>(
                    "supplierSorted", "supplierSorted.bin", allTables["supplier"]->getSchema());
                MyDB_TableReaderWriter outputTable(outTable, myMgr);
            ...
            cout << "Compare Sorted Table.." << endl << flush;
            {
                ...
                // load up the sorted text file
                otherSortedTable.loadFromTextFile("test/supplierBigSorted.tbl");
        ...
        case 7:
            ...
            countCorrect = 0;
            {
                ...
                MyDB_BufferManagerPtr myMgr =
                    make_shared<MyDB_BufferManager>(131072, 128, "test/tempFile");
                MyDB_TableReaderWriter sortedTable(allTables["supplierSorted"],
                                                   myMgr);  // The file is already sorted.
        ...
        case 8:
            ...
            cout << "Initialization.." << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr myTable =
                    make_shared<MyDB_Table>("newsupplier", "newsupplier.bin", mySchema);
                MyDB_BufferManagerPtr myMgr =
                    make_shared<MyDB_BufferManager>(131072, 128, "test/tempFile");
                MyDB_TableReaderWriter supplierTable(myTable, myMgr);

                // load it from a text file
                supplierTable.loadFromTextFile("test/supplierBigSorted.tbl");
            ...
            cout << "Sort a table.." << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr outTable =
                    make_shared<MyDB_Table>("newsupplierSorted", "newsupplierSorted.bin",
        ...
        case 10:
            ...
            cout << "Sort a table.." << flush;
            {
                ...
                // use the schema to create a table
                MyDB_TablePtr outTable =
                    make_shared<MyDB_Table>("supplierSortedRRS", "supplierSortedRRS.bin",
                                            allTables["supplier"]->getSchema());
                MyDB_TableReaderWriter outputTable(outTable, myMgr);
