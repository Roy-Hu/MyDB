...
int main (int argc, char *argv[]) {
	...
	cout << "Compare Sorted Table.." << endl << flush;
	{
		...
		// load up the sorted text file
		otherSortedTable.loadFromTextFile ("test/indexvalueBigSortedTwo.tbl");		//pre-sorted by value table
	...
	cout << "Compare Sorted Table.." << endl << flush;
	{
		...
		// load up the sorted text file
		otherSortedTable.loadFromTextFile ("test/indexvalueBigSorted.tbl");		//pre-sorted by index table
